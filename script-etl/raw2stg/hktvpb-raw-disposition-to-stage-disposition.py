...
source_table = "raw_disposition"
target_table = "disposition"
schema = "stage_data"
...
# Change Schema
ChangeSchema_node = ApplyMapping.apply(frame=SourceRaw_node, mappings=[("disp_id", "string", "disp_id", "string"), ("client_id", "string", "client_id", "string"), ("account_id", "string", "account_id", "string"), ("type", "string", "type", "string")], transformation_ctx="ChangeSchema_node")
