...
# Change Schema
ChangeSchema_node = ApplyMapping.apply(frame=SourceRaw_node, mappings=[("order_id", "long", "order_id", "long"), ("account_id", "string", "account_id", "string"), ("bank_to", "string", "bank_to", "string"), ("account_to", "long", "account_to", "long"), ("amount", "double", "amount", "double"), ("k_symbol", "string", "k_symbol", "string")], transformation_ctx="ChangeSchema_node")
