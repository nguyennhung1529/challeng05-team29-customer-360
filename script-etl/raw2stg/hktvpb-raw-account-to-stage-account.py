...
# Change Schema
# Change Schema
ChangeSchema_node = ApplyMapping.apply(frame=SourceRaw_node, mappings=[("account_id", "string", "account_id", "string"), ("district_id", "bigint", "district_id", "bigint"), ("frequency", "string", "frequency", "string"), ("parseddate", "string", "parseddate", "date"), ("year", "bigint", "year", "int"), ("month", "bigint", "month", "int"), ("day", "bigint", "day", "int")], transformation_ctx="ChangeSchema_node")
