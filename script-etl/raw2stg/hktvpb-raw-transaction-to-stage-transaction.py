...
# Change Schema
ChangeSchema_node = ApplyMapping.apply(frame=SourceRaw_node, mappings=[("trans_id", "string", "trans_id", "string"), ("account_id", "string", "account_id", "string"), ("type", "string", "type", "string"), ("operation", "string", "operation", "string"), ("amount", "double", "amount", "double"), ("balance", "double", "balance", "double"), ("k_symbol", "string", "k_symbol", "string"), ("bank", "string", "bank", "string"), ("account", "string", "account", "string"), ("year", "long", "year", "int"), ("month", "long", "month", "int"), ("day", "long", "day", "int"), ("fulldate", "string", "fulldate", "date"), ("fulltime", "string", "fulltime", "string"), ("fulldatewithtime", "string", "fulldatewithtime", "timestamp")], transformation_ctx="ChangeSchema_node")
